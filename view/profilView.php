<?php ob_start(); ?>
  ...
  <div class="form-group">
    ...
    <input class="form-control" id="oldPaasword" placeholder="Confirmez votre mot de pass actuel" required></br>
    <span class="text-danger" id="messagePassword"></span>
    <input type="email" class="form-control" id="newPassword" placeholder="Entrez votre nouveau mot de pass" required></br>
